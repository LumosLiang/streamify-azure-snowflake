...
Polaris has been validated with one Iceberg table created through Spark SQL and now receives a parallel `listen_events` streaming write path. The existing Parquet path is unchanged.
